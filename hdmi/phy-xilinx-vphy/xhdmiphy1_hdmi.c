...
* @param	buff_size Maximum size of buff
*
* @return	Number of characters printed in buff.
*
* @note		None.
*
******************************************************************************/

int XHdmiphy1_HdmiDebugInfo(XHdmiphy1 *InstancePtr, u8 QuadId,
        XHdmiphy1_ChannelId ChId, char *buff, int buff_size)
{
	int strSize = 0;
	u32 RegValue;
#if (XPAR_HDMIPHY1_0_TRANSCEIVER != XHDMIPHY1_GTYE5)
	...
	if (XHdmiphy1_IsHDMI(InstancePtr, XHDMIPHY1_DIR_RX)) {
		strSize += scnprintf(buff+strSize, buff_size-strSize,
			"RX MMCM settings\n"
			"-------------\n"
			"Mult : %d - Div : %d - Clk0Div : %d - Clk1Div : %d - "
			   "Clk2Div : %d\n\n",
