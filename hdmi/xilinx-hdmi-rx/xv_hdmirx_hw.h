...
*                          compliance
* 1.10  EB     15/11/17 Added XV_HDMIRX_AUX_STA_GCP_CD_EVT_MASK
* 1.10  YH     16/11/17 Added PIO_IN for bridge overflow interrupt
...
#define XV_HDMIRX_PIO_OUT_INT_VRST_MASK             (1<<0)  /**< PIO Out INT_VRST mask */
#define XV_HDMIRX_PIO_OUT_INT_LRST_MASK             (1<<20) /**< PIO Out INT_LRST mask */
#define XV_HDMIRX_PIO_OUT_EXT_VRST_MASK             (1<<21) /**< PIO Out EXT_VRST mask */
#define XV_HDMIRX_PIO_OUT_EXT_SYSRST_MASK           (1<<22) /**< PIO Out EXT_SYSRST mask */
...
*           u32 XV_HdmiRx_ReadReg(UINTPTR BaseAddress, u32 RegOffset)
*
******************************************************************************/
...
*
* @note     C-style signature:
*           void XV_HdmiRx_WriteReg(UINTPTR BaseAddress, u32 RegOffset, u32 Data)
*
******************************************************************************/
